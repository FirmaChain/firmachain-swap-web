    ...
    return (
        <>
            ...
            <IntroContainer>
                ...
                <DownloadWrapper>
                    <DownloadItem src={'/images/icon_web.png'} onClick={linktoWeb}></DownloadItem>
                    <DownloadItem src={'/images/icon_linux.png'} onClick={downloadLinux}></DownloadItem>
                    <DownloadItem src={'/images/icon_win.png'} onClick={downloadWin}></DownloadItem>
                    <DownloadItem src={'/images/icon_mac.png'} onClick={downloadMac}></DownloadItem>
                    <DownloadItem src={'/images/icon_m1.png'} onClick={downloadMacM1} style={{ width: '50px' }}></DownloadItem>
                </DownloadWrapper>
            </IntroContainer>
        </>
    );
